...
import { Button, Form, Row, Col, ProgressBar, InputGroup } from 'react-bootstrap'
    ...
    return (
        <>
            <div className="container">
                    <div className="p-4 row d-flex justify-content-center border border-2 rounded rounded-3 mt-5 shadow">
